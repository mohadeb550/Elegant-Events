...
export default function Offers() {
  ...
  return (
    <section className="my-24 flex flex-col-reverse lg:flex-row justify-between bg-red-50 py-10 md:py-16 lg:py-20 rounded-lg px-12 gap-4 md:gap-16 lg:gap-24">
        ...
        <div className='flex-1'>
            ...
            <div className='space-y-3'>
                <h1 className="text-4xl md:text-5xl lg:text-7xl opacity-95 font-black"> What we offer </h1>
            <div>
            <img src="/miking.jpg" className="w-96"/>
            </div>
