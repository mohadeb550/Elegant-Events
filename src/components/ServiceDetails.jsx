...
export default function ServiceDetails() {
  ...
  <div className={`absolute inset-0 m-0 overflow-hidden rounded-none bg-transparent bg-cover bg-clip-border bg-center text-gray-700 shadow-none`}> <img src={`${image === 'https://i.ibb.co/6rz2s0w/samantha-gades-2-Tdhw-S6-Y3p-U-unsplash.jpg'? 'https://i.ibb.co/T2HNyq4/pexels-criativithy-1805416.jpg' : image && image === 'https://i.ibb.co/F6NfcD3/leonardo-miranda-dv-F6s1-H1x68-unsplash.jpg'? 'https://i.ibb.co/pZxXv8P/pexels-luis-quintero-1560303.jpg' : image}`} className="h-full w-full object-cover"/>
  ...
  <div className="relative p-5 md:p-7 lg:p-10">
    ...
    {name}
      ...
      {features?.map((feature, index) => {
        return <div key={index} className="border-b border-yellow-600 p-3">
        <h4 className="text-xl md:text-2xl font-semibold text-gray-600"> {feature.package} </h4>
